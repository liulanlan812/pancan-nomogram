...
#pure TIL ---------------------------------------------------------------------------------------
#uni_res.sig
readr::read_tsv("/home/liull/TCGA_nomograph/TCGA_result/muli_uni_survival_20191123/OS_pure_multi_res.tsv")%>%
  dplyr::filter(coxp < 0.1)->OS_pure_uni_sig
...
index_value %>% readr::write_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/7_model_C_index_pure.tsv")

#compare C-index plot 
readr::read_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/7_model_C_index_pure.tsv")%>%
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/single_feature_train_C_pure.pdf",width = 12,height = 6)
ggplot(single_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/single_feature_test_C_pure.pdf",width = 12,height = 6)
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/multi_feature_train_C_pure.pdf",width = 12,height = 6)
ggplot(multi_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/multi_feature_test_C_pure.pdf",width = 12,height = 6)
...
#fixed_TIL-----------------------------------------------------------
readr::read_tsv("/home/liull/TCGA_nomograph/TCGA_result/muli_uni_survival_20191123/OS_fixed_multi_res.tsv")%>%
  dplyr::filter(coxp < 0.1)->OS_fixed_uni_sig
...
index_value %>% readr::write_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/7_model_C_index_fixed.tsv")


#compare C-index plot 
readr::read_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/7_model_C_index_fixed.tsv")%>%
  dplyr::filter(TNM_train_C != 0)%>%
  dplyr::filter(gene_sets_train_C != 0)%>%
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/single_feature_train_C_fixed.pdf",width = 12,height = 6)
ggplot(single_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/single_feature_test_C_fixed.pdf",width = 12,height = 6)
ggplot(single_feature_test_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/multi_feature_train_C_fixed.pdf",width = 12,height = 6)
ggplot(multi_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/muli_uni_model/multi_feature_test_C_fixed.pdf",width = 12,height = 6)
ggplot(multi_feature_test_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()
