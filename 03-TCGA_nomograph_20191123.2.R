...
##define high/low in train and test seperately
library(magrittr)
library(rms)
...
for (i in 1:nrow(TCGA_all)) {
  ...
  if(nrow(OS_stage) == 0){
    ...
    ddist <- datadist(split_values(all_sigs,4))
    options(datadist ='ddist')
    sample(all_sigs$barcode, ceiling(nrow(all_sigs)*0.7), replace = FALSE)->train_samples
    setdiff(all_sigs$barcode,train_samples)->test_samples
    ...
    if(ncol(ssGSEA) > 1 && ncol(pure_TIL) > 1){
      ...
      index_value[i,13:14] <- c(fn_nomogram_model(split_values(ssGSEA_pure_TIL_train,3))[2],fn_nomogram_model(split_values(ssGSEA_pure_TIL_test,3))[2])
    }else{
    ...
    ddist <- datadist(split_values(all_sigs,5))
    options(datadist ='ddist')
    ...
    if(ncol(ssGSEA) > 1){
      ...
      index_value[i,9:10] <- c(fn_nomogram_model(split_values(TNM_gene_sets_train,4))[2],fn_nomogram_model(split_values(TNM_gene_sets_test,4))[2])
    }else{
    ...
    if(ncol(pure_TIL) > 1){
      ...
      index_value[i,11:12] <- c(fn_nomogram_model(split_values(TNM_pure_TIL_train,4))[2],fn_nomogram_model(split_values(TNM_pure_TIL_test,4))[2])
    }else{
    ...
    if(ncol(ssGSEA) > 1 && ncol(pure_TIL) > 1){
      ...
      index_value[i,13:14] <- c(fn_nomogram_model(split_values(gene_sets_pure_TIL_train,3))[2],fn_nomogram_model(split_values(gene_sets_pure_TIL_test,3))[2])
      ...
      index_value[i,15:16] <- c(fn_nomogram_model(split_values(all_sigs_train,4))[2],fn_nomogram_model(split_values(all_sigs_test,4))[2])
    }else{
      index_value[i,13:14] <- c(rep(0,2))
  ...
  if(ncol(ssGSEA) > 1){
    ...
    index_value[i,5:6] <- c(fn_nomogram_model(split_values(gene_sets_train,3))[2],fn_nomogram_model(split_values(gene_sets_test,3))[2])
  ...
  if(ncol(pure_TIL) > 1){
    ...
    index_value[i,7:8] <- c(fn_nomogram_model(split_values(pure_TIL_train,3))[2],fn_nomogram_model(split_values(pure_TIL_test,3))[2])
...
index_value %>% readr::write_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/7_model_C_index_pure_2.tsv")


#compare C-index plot 
readr::read_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/7_model_C_index_pure_2.tsv")%>%
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/single_feature_train_C_pure_2.pdf",width = 12,height = 6)
ggplot(single_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/single_feature_test_C_pure_2.pdf",width = 12,height = 6)
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/multi_feature_train_C_pure_2.pdf",width = 12,height = 6)
ggplot(multi_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/multi_feature_test_C_pure_2.pdf",width = 12,height = 6)
...
for (i in 1:nrow(filtered_TCGA)) {
  ...
  if(nrow(OS_stage) == 0){
    ...
    if(ncol(ssGSEA) > 1 && ncol(fixed_TIL) > 1){
      ...
      index_value[i,13:14] <- c(fn_nomogram_model(split_values(ssGSEA_fixed_TIL_train,3))[2],fn_nomogram_model(split_values(ssGSEA_fixed_TIL_test,3))[2])
    }else{
      index_value[i,13:14] <- c(rep(0,2))
    }
    ...
    if(ncol(fixed_TIL) > 1){
      ...
      index_value[i,11:12] <- c(fn_nomogram_model(split_values(TNM_fixed_TIL_train,4))[2],fn_nomogram_model(split_values(TNM_fixed_TIL_test,4))[2])
    }else{
      index_value[i,11:12] <- c(rep(0,2))
    }
    ...
    if(ncol(ssGSEA) > 1 && ncol(fixed_TIL) > 1){
      ...
      index_value[i,13:14] <- c(fn_nomogram_model(split_values(gene_sets_fixed_TIL_train,3))[2],fn_nomogram_model(split_values(gene_sets_fixed_TIL_test,3))[2])
  ...
  if(ncol(fixed_TIL) > 1){
    ...
    index_value[i,7:8] <- c(fn_nomogram_model(split_values(fixed_TIL_train,3))[2],fn_nomogram_model(split_values(fixed_TIL_test,3))[2])
...
index_value %>% readr::write_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/7_model_C_index_fixed_2.tsv")



#compare C-index plot 
readr::read_tsv("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/7_model_C_index_fixed_2.tsv")%>%
  dplyr::filter(TNM_train_C != 0)%>%
  dplyr::filter(gene_sets_train_C != 0)%>%
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/single_feature_train_C_fixed_2.pdf",width = 12,height = 6)
ggplot(single_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/single_feature_test_C_fixed_2.pdf",width = 12,height = 6)
ggplot(single_feature_test_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()
...
pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/multi_feature_train_C_fixed_2.pdf",width = 12,height = 6)
ggplot(multi_feature_train_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()

pdf("/home/liull/TCGA_nomograph/TCGA_result/nomograph_model/nomograph_ssGSEA/multi_feature_test_C_fixed_2.pdf",width = 12,height = 6)
ggplot(multi_feature_test_C_plot, aes(x=cancer_types,y=C_index,colour=type,group=type))+ geom_line() + theme_bw()
dev.off()
